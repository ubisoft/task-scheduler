...
namespace unittests {
	...
	UnitTestAtomicIncrement()
	{
		...
		int64_t vi64 = (uint64_t)UINT32_MAX;
		MG_COMMON_ASSERT(mg::common::AtomicIncrement64(&vi64) == (int64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(vi64 == (int64_t)UINT32_MAX + 1);
	}
	...
	UnitTestAtomicExchange()
	{
		...
		int64_t vi64 = (int64_t)UINT32_MAX + 1;
		MG_COMMON_ASSERT(mg::common::AtomicExchange64(&vi64, (int64_t)UINT32_MAX + 10) ==
			(int64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(vi64 == (int64_t)UINT32_MAX + 10);

		uint64_t vu64 = (uint64_t)UINT32_MAX + 1;
		MG_COMMON_ASSERT(mg::common::AtomicExchangeU64(&vu64, (uint64_t)UINT32_MAX + 10) ==
			(uint64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(vu64 == (uint64_t)UINT32_MAX + 10);
	...
	UnitTestAtomicCompareExchange()
	{
		...
		int64_t vi64 = (int64_t)UINT32_MAX + 1;
		MG_COMMON_ASSERT(mg::common::AtomicCompareExchange64(&vi64, (int64_t)UINT32_MAX + 10,
			(int64_t)UINT32_MAX + 5) == (int64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(vi64 == (int64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(mg::common::AtomicCompareExchange64(&vi64, (int64_t)UINT32_MAX + 10,
			(int64_t)UINT32_MAX + 1) == (int64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(vi64 == (int64_t)UINT32_MAX + 10);
	...
	UnitTestAtomicAdd()
	{
		...
		int64_t vi64 = (int64_t)UINT32_MAX + 1;
		MG_COMMON_ASSERT(mg::common::AtomicAdd64(&vi64, 2) == (int64_t)UINT32_MAX + 1);
		MG_COMMON_ASSERT(vi64 == (int64_t)UINT32_MAX + 3);
	}
